...
public class ReportGeneration {
	...
	try {
		...
		for (Report report1 : list) {
			...
			System.out.println(report1.getPolicyNumber()+"\t"+report1.getClaimNumber()+"\t"+report1.getClaimType()+"\t"+userName);
			...
			do {
		       ...
		       if(Pattern.matches("[0-9]{10}$", policyNumber.toString()))
				...
				break;
					...
					System.err.println("Enter valid policy number which you are eligible for");
				}
				}
		    	   }
		       else {
